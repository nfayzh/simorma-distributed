...
-- NODE 4: UKM
-- Menyimpan: User UKM, Surat UKM, Draft Proposal UKM
...
-- SURAT UKM (data asli/master ada di sini, mirror-nya dikirim ke BEM)
...
-- DRAFT PROPOSAL UKM
CREATE TABLE IF NOT EXISTS draft_proposal_ukm (
...
CREATE INDEX IF NOT EXISTS idx_letter_ukm_org ON letter_ukm(organization_id);
CREATE INDEX IF NOT EXISTS idx_draft_proposal_ukm_org ON draft_proposal_ukm(organization_id);